...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Bikram"<<endl;
        string phrase = "Good Morning Master Bikram";
        ...
        cout<< "Good Afternoon Master Bikram"<<endl;
        string phrase = "Good Afternoon Master Bikram";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Bikram"<<endl;
        string phrase = "Good Evening Master Bikram";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER BIKRAM |"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER BIKRAM";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="bikram")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Bikram...."<<endl<<endl;

                string phrase = "How can i help you Master Bikram";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Bikram....."<<endl;
                    string phrase = "Hello Master Bikram";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Bikram !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Bikram !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"Good Bye Master Bikram, see you soon!"<<endl;
                    string phrase = "Good Bye Master Bikram, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
